...
# depth = 0 to 4
my_ai_search_depth = 2
# depth = 1 to 5
opponent_ai_search_depth = 5
...
for num_sims in range(NUM_SIMULATIONS):
    print("\nStarting simulation:", num_sims)
